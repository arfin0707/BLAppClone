...
public class CommerceFragment2 extends Fragment {
    View root;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root= inflater.inflate(R.layout.fragment_commerce2, container, false);
    ...
    private void customizeColors() {
        ...
        if (toolbar != null) {
            toolbar.setBackgroundColor(
                  //  ContextCompat.getColor(requireContext(), R.color.commerce_toolbar_color)
...
/*        // Change navigation bar color (optional)
        ...
        updateSelectedNavigationItem(bottomNavigationView2, R.id.navigation_commerce2);
    }
        ...
        for (int i = 0; i < bottomNavigationView.getMenu().size(); i++) {
            ...
            if (itemView != null) {
                ...
                if (menuItemId == selectedItemId) {
                    itemView.setBackgroundResource(R.drawable.a_rounded_background_green);
                } else {
...
/*        if (timer != null) {
        ...
        resetNavigationItemToDefault(bottomNavigationView2, R.id.navigation_commerce2);
    }

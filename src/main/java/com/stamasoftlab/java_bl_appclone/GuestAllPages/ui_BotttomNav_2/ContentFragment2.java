...
public class ContentFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root= inflater.inflate(R.layout.fragment_content2, container, false);
...
/*        // Change navigation bar color (optional)
        ...
        updateSelectedNavigationItem(bottomNavigationView2, R.id.navigation_content2);
    }
...
/*        if (timer != null) {
        ...
        resetNavigationItemToDefault(bottomNavigationView2, R.id.navigation_content2);
    }

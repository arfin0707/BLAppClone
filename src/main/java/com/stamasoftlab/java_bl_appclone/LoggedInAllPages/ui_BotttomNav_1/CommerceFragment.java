...
public class CommerceFragment extends Fragment {
    ...
    private static final int AUTO_SCROLL_DELAY = 3000; // 3
    BottomNavigationView bottomNavigationView;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        root= inflater.inflate(R.layout.fragment_commerce, container, false);
...
/*        // Change navigation bar color (optional)
        ...
        updateSelectedNavigationItem(bottomNavigationView, R.id.navigation_commerce);
    }
    ...
    public void onDestroyView() {
        ...
        resetNavigationItemToDefault(bottomNavigationView, R.id.navigation_commerce);
    }
